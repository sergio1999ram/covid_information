...
const TotalCases = ({ country, navigation, dailyTotalData, type }) => {
    ...
    return(
        <TouchableOpacity onPress={() => navigation.navigate("TotalCasesScreen", {dailyTotalData: dailyTotalData, type: type})}>
